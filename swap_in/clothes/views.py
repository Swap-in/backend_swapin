...
def create_like(request):
    ...
    try:
        ...
        return Response("The user or selected clothing does not exist",status=status.HTTP_400_BAD_REQUEST)
...
def list_notifications_by_user(self,id):
    ...
    try:
        ...
        return Response("The selected user does not exist",status=status.HTTP_400_BAD_REQUEST)
...
def notification_read(request):
    ...
    try:
        ...
        return Response("Invalid notification id",status=status.HTTP_400_BAD_REQUEST)
...
def search_match(like_user):
    ...
    likes = like.objects.filter(Q(type_like='SUPERLIKE') | Q(type_like='LIKE'),clothe_id__in = [clothes.id for clothes in clothes_filter],user_id = user_id_clothe).count()
...
def list_notifications_by_clothe(self,id):
    ...
    try:
        ...
        return Response("The selected clothing does not exist",status=status.HTTP_400_BAD_REQUEST)
...
def search_clothes_by_category(self,id_category,id_user):
    ...
    try:
        ...
        return Response("Category or User not valid",status=status.HTTP_400_BAD_REQUEST)
